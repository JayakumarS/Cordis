...
public class ErrorMessage {
	...
	public static final String ERROR_UPDATE = "Unable to update record";
	public static final String ERROR_DELETE = "Unable to delete record";
